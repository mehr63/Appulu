...
namespace Appulu.Plugin.Payments.CheckMoneyOrder
{
    /// <summary>
    ...
    public class CheckMoneyOrderPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payment.CheckMoneyOrder.DescriptionText.Hint", "Enter info that will be shown to users during checkout");
