...
namespace Appulu.Plugin.Pickup.PickupInStore.Services
{
    /// <summary>
    ...
    public partial class StorePickupPointService : IStorePickupPointService
    {
        ...
        /// {2} : current store ID
        /// </remarks>
        private const string PICKUP_POINT_ALL_KEY = "App.pickuppoint.all-{0}-{1}-{2}";
        private const string PICKUP_POINT_PATTERN_KEY = "App.pickuppoint.";
