...
namespace Appulu.Plugin.Payments.Square
{
    ...
    public static class SquarePaymentDefaults
    {
        ...
        /// </summary>
        public static string UserAgent => "Square-connect-Appulu-1.0";
        ...
        /// <summary>
        /// Key of the attribute to store Square user identifier
        /// </summary>
        public static string UserIdAttribute => "SquareUserId";
        ...
        /// </summary>
        public static string RenewAccessTokenTask => "App.Plugin.Payments.Square.Services.RenewAccessTokenTask";
        ...
        /// {0} : Order Guid
        /// </remarks>
        public static string PaymentNote => "Appulu: {0}";
    }
}