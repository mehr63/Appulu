...
namespace Appulu.Plugin.Widgets.GoogleAnalytics
{
    ...
    public class GoogleAnalyticsPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override void Install()
        {
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.TrackingScript.Hint", "Paste the tracking code generated by Google Analytics here. {GOOGLEID} and {USER_TRACKING} will be dynamically replaced.");
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.UseJsToSendEcommerceInfo.Hint", "Check to use JS code to send eCommerce info from the order completed page. But in case of redirection payment methods some users may skip it. Otherwise, e-commerce information will be sent using HTTP request. Information is sent each time an order is paid but UTM is not supported in this mode.");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.IncludeUserId", "Include user ID");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.IncludeUserId.Hint", "Check to include user identifier to script.");
        ...
        public override void Uninstall()
        {
            ...
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.IncludeUserId");
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.GoogleAnalytics.IncludeUserId.Hint");
