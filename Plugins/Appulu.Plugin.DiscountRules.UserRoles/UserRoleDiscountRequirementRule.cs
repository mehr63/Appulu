...
{
    public partial class UserRoleDiscountRequirementRule : BasePlugin, IDiscountRequirementRule
    {
        #region Fields
        ...
        public DiscountRequirementValidationResult CheckRequirement(DiscountRequirementValidationRequest request)
        {
            ...
            result.IsValid = request.User.UserRoles.Any(role => role.Id == restrictedRoleId && role.Active);
        ...
        {
            //locales
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.UserRoles.Fields.UserRole", "Required user role");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.UserRoles.Fields.UserRole.Hint", "Discount will be applied if user is in the selected user role.");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.UserRoles.Fields.UserRole.Select", "Select user role");
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResource("Plugins.DiscountRules.UserRoles.Fields.UserRole");
            _localizationService.DeletePluginLocaleResource("Plugins.DiscountRules.UserRoles.Fields.UserRole.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.DiscountRules.UserRoles.Fields.UserRole.Select");
