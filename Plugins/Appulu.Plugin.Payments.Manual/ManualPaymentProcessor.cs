...
using Appulu.Plugin.Payments.Manual.Models;
using Appulu.Plugin.Payments.Manual.Validators;
using Appulu.Services.Configuration;
using Appulu.Services.Localization;
using Appulu.Services.Payments;

namespace Appulu.Plugin.Payments.Manual
{
    /// <summary>
    ...
    public class ManualPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.Manual.Fields.AdditionalFee.Hint", "Enter additional fee to charge your users.");
