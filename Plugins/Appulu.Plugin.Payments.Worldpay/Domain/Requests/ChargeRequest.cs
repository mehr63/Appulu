...
namespace Appulu.Plugin.Payments.Worldpay.Domain.Requests
{
    ...
    public class ChargeRequest : WorldpayPaymentRequest
    {
        ...
        /// Duplicates are evaluated on the basis of amount, card number, and order ID; these evaluation criteria can be extended to also include user ID, invoice number, or a user-defined field. 
