...
namespace Appulu.Plugin.Payments.Worldpay.Domain.Requests
{
    ...
    public class CreateTokenRequest : WorldpayPostRequest
    {
        ...
        /// <summary>
        /// Gets or sets a user identifier to associate to the token. 
        /// If the addToVault parameter is set to true and a userId is not sent in the request, a userId will automatically be created and sent back in the response.
        /// </summary>
        [JsonProperty("userId")]
