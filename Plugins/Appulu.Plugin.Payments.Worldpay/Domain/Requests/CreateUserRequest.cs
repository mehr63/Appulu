...
{
    /// <summary>
    /// Represents request parameters to create a user in Vault.
    /// </summary>
    public class CreateUserRequest : WorldpayPostRequest
    {
        #region Properties
        ...
        /// </summary>
        /// <returns>URL</returns>
        public override string GetRequestUrl() => "api/Users";
