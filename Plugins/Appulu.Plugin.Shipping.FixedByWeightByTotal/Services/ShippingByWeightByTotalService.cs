...
namespace Appulu.Plugin.Shipping.FixedByWeightByTotal.Services
{
    /// <summary>
    ...
    public partial class ShippingByWeightByTotalService : IShippingByWeightByTotalService
    {
        ...
        /// {1} : page size
        /// </remarks>
        private const string SHIPPINGBYWEIGHTBYTOTAL_ALL_KEY = "App.shippingbyweightbytotal.all-{0}-{1}";
        private const string SHIPPINGBYWEIGHTBYTOTAL_PATTERN_KEY = "App.shippingbyweightbytotal.";
