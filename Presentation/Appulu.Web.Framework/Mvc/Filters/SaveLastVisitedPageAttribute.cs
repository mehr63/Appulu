    ...
    public class SaveLastVisitedPageAttribute : TypeFilterAttribute
    {
        ...
        private class SaveLastVisitedPageFilter : IActionFilter
        {
            ...
            public void OnActionExecuting(ActionExecutingContext context)
            {
                ...
                var previousPageUrl = _genericAttributeService.GetAttribute<string>(_workContext.CurrentUser, AppUserDefaults.LastVisitedPageAttribute);

                //save new one if don't match
                if (!pageUrl.Equals(previousPageUrl, StringComparison.InvariantCultureIgnoreCase))
                    _genericAttributeService.SaveAttribute(_workContext.CurrentUser, AppUserDefaults.LastVisitedPageAttribute, pageUrl);
