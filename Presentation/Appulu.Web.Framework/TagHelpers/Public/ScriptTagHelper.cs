...
namespace Appulu.Web.Framework.TagHelpers.Public
{
    ...
    public class ScriptTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (_httpContextAccessor.HttpContext.Items["app.IgnoreScriptTagLocation"] != null &&
                Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["app.IgnoreScriptTagLocation"]))
                return;
