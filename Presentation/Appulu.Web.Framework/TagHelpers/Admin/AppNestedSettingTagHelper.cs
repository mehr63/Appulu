...
namespace Appulu.Web.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("app-nested-setting", Attributes = ForAttributeName)]
    public class AppNestedSettingTagHelper : TagHelper
    {
        ...
        public AppNestedSettingTagHelper(IHtmlGenerator generator, AdminAreaSettings adminAreaSettings)
        {
            Generator = generator;
