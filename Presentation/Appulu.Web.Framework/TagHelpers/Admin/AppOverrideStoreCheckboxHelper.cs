...
{
    /// <summary>
    /// app-override-store-checkbox tag helper
    /// </summary>
    [HtmlTargetElement("app-override-store-checkbox", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class AppOverrideStoreCheckboxHelper : TagHelper
    {
        ...
        public AppOverrideStoreCheckboxHelper(IHtmlHelper htmlHelper)
        {
