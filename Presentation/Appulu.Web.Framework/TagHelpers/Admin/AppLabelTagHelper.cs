...
namespace Appulu.Web.Framework.TagHelpers.Admin
{
    /// <summary>
    ...
    public class AppLabelTagHelper : TagHelper
    {
        ...
        public AppLabelTagHelper(IHtmlGenerator generator, IWorkContext workContext, ILocalizationService localizationService)
        {
            Generator = generator;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (tagBuilder != null)
            {
                ...
                //add hint
                if (For.Metadata.AdditionalValues.TryGetValue("AppResourceDisplayNameAttribute", out object value))
                {
                    var resourceDisplayName = value as AppResourceDisplayNameAttribute;
