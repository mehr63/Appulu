    ...
    public partial class AddressModelFactory : IAddressModelFactory
    {
            ...
            string overrideAttributesXml = "")
        {
            ...
            if (address == null && prePopulateWithUserFields)
            {
                ...
                model.Address1 = _genericAttributeService.GetAttribute<string>(user, AppUserDefaults.StreetAddressAttribute);
                model.Address2 = _genericAttributeService.GetAttribute<string>(user, AppUserDefaults.StreetAddress2Attribute);
                ...
                model.PhoneNumber = _genericAttributeService.GetAttribute<string>(user, AppUserDefaults.PhoneAttribute);
                model.FaxNumber = _genericAttributeService.GetAttribute<string>(user, AppUserDefaults.FaxAttribute);
            }
