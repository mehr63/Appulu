    ...
    public partial class CheckoutModelFactory : ICheckoutModelFactory
    {
            ...
            bool prePopulateNewAddressWithUserFields = false, string overrideAttributesXml = "")
        {
            ...
            if (model.AllowPickUpInStore)
            {
                ...
                var pickupPointProviders = _shippingService.LoadActivePickupPointProviders(_workContext.CurrentUser, _storeContext.CurrentStore.Id);
                if (pickupPointProviders.Any())
                {
                    var languageId = _workContext.WorkingLanguage.Id;
                    var pickupPointsResponse = _shippingService.GetPickupPoints(_workContext.CurrentUser.BillingAddress,
                ...
                if (!_shippingService.LoadActiveShippingRateComputationMethods(_workContext.CurrentUser, _storeContext.CurrentStore.Id).Any())
                {
                    if (!pickupPointProviders.Any())
                    {
        ...
        public virtual CheckoutShippingMethodModel PrepareShippingMethodModel(IList<ShoppingCartItem> cart, Address shippingAddress)
        {
            ...
            if (getShippingOptionResponse.Success)
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentUser,
                                                       AppUserDefaults.OfferedShippingOptionsAttribute,
        ...
        public virtual CheckoutPaymentMethodModel PreparePaymentMethodModel(IList<ShoppingCartItem> cart, int filterByCountryId)
        {
            ...
            var paymentMethods = _paymentService
                .LoadActivePaymentMethods(_workContext.CurrentUser, _storeContext.CurrentStore.Id, filterByCountryId)
