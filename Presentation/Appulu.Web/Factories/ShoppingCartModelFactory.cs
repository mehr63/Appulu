    ...
    public partial class ShoppingCartModelFactory : IShoppingCartModelFactory
    {
        ...
        protected virtual IList<ShoppingCartModel.CheckoutAttributeModel> PrepareCheckoutAttributeModels(IList<ShoppingCartItem> cart)
        {
            ...
            foreach (var attribute in checkoutAttributes)
            {
                ...
                var selectedCheckoutAttributes = _genericAttributeService.GetAttribute<string>(_workContext.CurrentUser,
        ...
        protected virtual ShoppingCartModel.OrderReviewDataModel PrepareOrderReviewDataModel(IList<ShoppingCartItem> cart)
        {
            ...
            //billing info
            var billingAddress = _workContext.CurrentUser.BillingAddress;
            ...
            if (_shoppingCartService.ShoppingCartRequiresShipping(cart))
            {
                ...
                {
                    if (_workContext.CurrentUser.ShippingAddress != null)
                    {
                        _addressModelFactory.PrepareAddressModel(model.ShippingAddress,
                            address: _workContext.CurrentUser.ShippingAddress,
                            excludeProperties: false,
                            addressSettings: _addressSettings);
                    }
                }
                ...
                var shippingOption = _genericAttributeService.GetAttribute<ShippingOption>(_workContext.CurrentUser,
                    AppUserDefaults.SelectedShippingOptionAttribute, _storeContext.CurrentStore.Id);
                if (shippingOption != null)
                    model.ShippingMethod = shippingOption.Name;
            }

            //payment info
            var selectedPaymentMethodSystemName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentUser, AppUserDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
        ...
        public virtual EstimateShippingModel PrepareEstimateShippingModel(IList<ShoppingCartItem> cart, bool setEstimateShippingDefaultAddress = true)
        {
            ...
            {
                //countries
                var defaultEstimateCountryId = (setEstimateShippingDefaultAddress && _workContext.CurrentUser.ShippingAddress != null)
                    ? _workContext.CurrentUser.ShippingAddress.CountryId
                    : model.CountryId;
                ...
                //states
                var defaultEstimateStateId = (setEstimateShippingDefaultAddress && _workContext.CurrentUser.ShippingAddress != null)
                    ? _workContext.CurrentUser.ShippingAddress.StateProvinceId
                ...
                if (setEstimateShippingDefaultAddress && _workContext.CurrentUser.ShippingAddress != null)
                    model.ZipPostalCode = _workContext.CurrentUser.ShippingAddress.ZipPostalCode;
            }
        ...
        public virtual MiniShoppingCartModel PrepareMiniShoppingCartModel()
        {
            var model = new MiniShoppingCartModel
            {
                ...
                CurrentUserIsGuest = _workContext.CurrentUser.IsGuest(),
                ...
                if (cart.Any())
                {
                    ...
                    model.DisplayCheckoutButton = !_orderSettings.TermsOfServiceOnShoppingCartPage &&
                        ...
                        !(downloadableProductsRequireRegistration
                            && _workContext.CurrentUser.IsGuest());
        ...
        public virtual OrderTotalsModel PrepareOrderTotalsModel(IList<ShoppingCartItem> cart, bool isEditable)
        {
            ...
            if (cart.Any())
            {
                ...
                //payment method fee
                var paymentMethodSystemName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentUser, AppUserDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
        ...
        public virtual EstimateShippingResultModel PrepareEstimateShippingResultModel(IList<ShoppingCartItem> cart, int? countryId, int? stateProvinceId, string zipPostalCode)
        {
            ...
            if (_shoppingCartService.ShoppingCartRequiresShipping(cart))
            {
                ...
                {
                    var pickupPointsResponse = _shippingService.GetPickupPoints(address, _workContext.CurrentUser, storeId: _storeContext.CurrentStore.Id);
