...
namespace Appulu.Web.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<PluginUpdatedEvent>
    {
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string SEARCH_CATEGORIES_MODEL_KEY = "App.pres.search.categories-{0}-{1}-{2}";
        public const string SEARCH_CATEGORIES_PATTERN_KEY = "App.pres.search.categories";
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string MANUFACTURER_NAVIGATION_MODEL_KEY = "App.pres.manufacturer.navigation-{0}-{1}-{2}-{3}";
        public const string MANUFACTURER_NAVIGATION_PATTERN_KEY = "App.pres.manufacturer.navigation";

        /// <summary>
        /// Key for VendorNavigationModel caching
        /// </summary>
        public const string VENDOR_NAVIGATION_MODEL_KEY = "App.pres.vendor.navigation";
        public const string VENDOR_NAVIGATION_PATTERN_KEY = "App.pres.vendor.navigation";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string MANUFACTURER_HAS_FEATURED_PRODUCTS_KEY = "App.pres.manufacturer.hasfeaturedproducts-{0}-{1}-{2}";
        public const string MANUFACTURER_HAS_FEATURED_PRODUCTS_PATTERN_KEY = "App.pres.manufacturer.hasfeaturedproducts";
        public const string MANUFACTURER_HAS_FEATURED_PRODUCTS_PATTERN_KEY_BY_ID = "App.pres.manufacturer.hasfeaturedproducts-{0}-";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string CATEGORY_ALL_MODEL_KEY = "App.pres.category.all-{0}-{1}-{2}";
        public const string CATEGORY_ALL_PATTERN_KEY = "App.pres.category.all";
        ...
        /// {2} : category ID
        /// </remarks>
        public const string CATEGORY_NUMBER_OF_PRODUCTS_MODEL_KEY = "App.pres.category.numberofproducts-{0}-{1}-{2}";
        public const string CATEGORY_NUMBER_OF_PRODUCTS_PATTERN_KEY = "App.pres.category.numberofproducts";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string CATEGORY_HAS_FEATURED_PRODUCTS_KEY = "App.pres.category.hasfeaturedproducts-{0}-{1}-{2}";
        public const string CATEGORY_HAS_FEATURED_PRODUCTS_PATTERN_KEY = "App.pres.category.hasfeaturedproducts";
        public const string CATEGORY_HAS_FEATURED_PRODUCTS_PATTERN_KEY_BY_ID = "App.pres.category.hasfeaturedproducts-{0}-";
        ...
        /// {3} : language ID
        /// </remarks>
        public const string CATEGORY_BREADCRUMB_KEY = "App.pres.category.breadcrumb-{0}-{1}-{2}-{3}";
        public const string CATEGORY_BREADCRUMB_PATTERN_KEY = "App.pres.category.breadcrumb";
        ...
        /// </remarks>
        public const string CATEGORY_SUBCATEGORIES_KEY = "App.pres.category.subcategories-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CATEGORY_SUBCATEGORIES_PATTERN_KEY = "App.pres.category.subcategories";
        ...
        /// </remarks>
        public const string CATEGORY_HOMEPAGE_KEY = "App.pres.category.homepage-{0}-{1}-{2}-{3}-{4}";
        public const string CATEGORY_HOMEPAGE_PATTERN_KEY = "App.pres.category.homepage";
        ...
        /// {1} : language id
        /// </remarks>
        public const string SPECS_FILTER_MODEL_KEY = "App.pres.filter.specs-{0}-{1}";
        public const string SPECS_FILTER_PATTERN_KEY = "App.pres.filter.specs";
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string PRODUCT_BREADCRUMB_MODEL_KEY = "App.pres.product.breadcrumb-{0}-{1}-{2}-{3}";
        public const string PRODUCT_BREADCRUMB_PATTERN_KEY = "App.pres.product.breadcrumb";
        public const string PRODUCT_BREADCRUMB_PATTERN_KEY_BY_ID = "App.pres.product.breadcrumb-{0}-";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCTTAG_BY_PRODUCT_MODEL_KEY = "App.pres.producttag.byproduct-{0}-{1}-{2}";
        public const string PRODUCTTAG_BY_PRODUCT_PATTERN_KEY = "App.pres.producttag.byproduct";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCTTAG_POPULAR_MODEL_KEY = "App.pres.producttag.popular-{0}-{1}";
        public const string PRODUCTTAG_POPULAR_PATTERN_KEY = "App.pres.producttag.popular";
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string PRODUCT_MANUFACTURERS_MODEL_KEY = "App.pres.product.manufacturers-{0}-{1}-{2}-{3}";
        public const string PRODUCT_MANUFACTURERS_PATTERN_KEY = "App.pres.product.manufacturers";
        public const string PRODUCT_MANUFACTURERS_PATTERN_KEY_BY_ID = "App.pres.product.manufacturers-{0}-";
        ...
        /// {1} : language id
        /// </remarks>
        public const string PRODUCT_SPECS_MODEL_KEY = "App.pres.product.specs-{0}-{1}";
        public const string PRODUCT_SPECS_PATTERN_KEY = "App.pres.product.specs";
        public const string PRODUCT_SPECS_PATTERN_KEY_BY_ID = "App.pres.product.specs-{0}-";
        ...
        /// {0} : product id
        /// </remarks>
        public const string PRODUCT_HAS_PRODUCT_ATTRIBUTES_KEY = "App.pres.product.hasproductattributes-{0}-";
        public const string PRODUCT_HAS_PRODUCT_ATTRIBUTES_PATTERN_KEY = "App.pres.product.hasproductattributes";
        public const string PRODUCT_HAS_PRODUCT_ATTRIBUTES_PATTERN_KEY_BY_ID = "App.pres.product.hasproductattributes-{0}-";
        ...
        /// </remarks>
        public const string TOPIC_MODEL_BY_SYSTEMNAME_KEY = "App.pres.topic.details.bysystemname-{0}-{1}-{2}-{3}";
        /// <summary>
        /// Key for TopicModel caching
        /// </summary>
        /// <remarks>
        ...
        /// {3} : comma separated list of user roles
        /// </remarks>
        public const string TOPIC_MODEL_BY_ID_KEY = "App.pres.topic.details.byid-{0}-{1}-{2}-{3}";
        /// <summary>
        /// Key for TopicModel caching
        /// </summary>
        /// <remarks>
        ...
        /// {3} : comma separated list of user roles
        /// </remarks>
        public const string TOPIC_SENAME_BY_SYSTEMNAME = "App.pres.topic.sename.bysystemname-{0}-{1}-{2}-{3}";
        /// <summary>
        /// Key for TopicModel caching
        /// </summary>
        /// <remarks>
        ...
        /// {3} : comma separated list of user roles
        /// </remarks>
        public const string TOPIC_TITLE_BY_SYSTEMNAME = "App.pres.topic.title.bysystemname-{0}-{1}-{2}-{3}";
        /// <summary>
        ...
        /// {2} : comma separated list of user roles
        /// </remarks>
        public const string TOPIC_TOP_MENU_MODEL_KEY = "App.pres.topic.topmenu-{0}-{1}-{2}";
        /// <summary>
        /// Key for TopMenuModel caching
        /// </summary>
        /// <remarks>
        ...
        /// {2} : comma separated list of user roles
        /// </remarks>
        public const string TOPIC_FOOTER_MODEL_KEY = "App.pres.topic.footer-{0}-{1}-{2}";
        public const string TOPIC_PATTERN_KEY = "App.pres.topic";
        ...
        /// </remarks>
        public const string CATEGORY_TEMPLATE_MODEL_KEY = "App.pres.categorytemplate-{0}";
        public const string CATEGORY_TEMPLATE_PATTERN_KEY = "App.pres.categorytemplate";
        ...
        /// </remarks>
        public const string MANUFACTURER_TEMPLATE_MODEL_KEY = "App.pres.manufacturertemplate-{0}";
        public const string MANUFACTURER_TEMPLATE_PATTERN_KEY = "App.pres.manufacturertemplate";
        ...
        /// </remarks>
        public const string PRODUCT_TEMPLATE_MODEL_KEY = "App.pres.producttemplate-{0}";
        public const string PRODUCT_TEMPLATE_PATTERN_KEY = "App.pres.producttemplate";
        ...
        /// {0} : topic template id
        /// </remarks>
        public const string TOPIC_TEMPLATE_MODEL_KEY = "App.pres.topictemplate-{0}";
        public const string TOPIC_TEMPLATE_PATTERN_KEY = "App.pres.topictemplate";
        ...
        /// {0} : current store ID
        /// </remarks>
        public const string HOMEPAGE_BESTSELLERS_IDS_KEY = "App.pres.bestsellers.homepage-{0}";
        public const string HOMEPAGE_BESTSELLERS_IDS_PATTERN_KEY = "App.pres.bestsellers.homepage";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCTS_ALSO_PURCHASED_IDS_KEY = "App.pres.alsopuchased-{0}-{1}";
        public const string PRODUCTS_ALSO_PURCHASED_IDS_PATTERN_KEY = "App.pres.alsopuchased";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCTS_RELATED_IDS_KEY = "App.pres.related-{0}-{1}";
        public const string PRODUCTS_RELATED_IDS_PATTERN_KEY = "App.pres.related";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string PRODUCT_DEFAULTPICTURE_MODEL_KEY = "App.pres.product.detailspictures-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string PRODUCT_DEFAULTPICTURE_PATTERN_KEY = "App.pres.product.detailspictures";
        public const string PRODUCT_DEFAULTPICTURE_PATTERN_KEY_BY_ID = "App.pres.product.detailspictures-{0}-";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string PRODUCT_DETAILS_PICTURES_MODEL_KEY = "App.pres.product.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string PRODUCT_DETAILS_PICTURES_PATTERN_KEY = "App.pres.product.picture";
        public const string PRODUCT_DETAILS_PICTURES_PATTERN_KEY_BY_ID = "App.pres.product.picture-{0}-";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string PRODUCT_REVIEWS_MODEL_KEY = "App.pres.product.reviews-{0}-{1}";
        public const string PRODUCT_REVIEWS_PATTERN_KEY = "App.pres.product.reviews";
        public const string PRODUCT_REVIEWS_PATTERN_KEY_BY_ID = "App.pres.product.reviews-{0}-";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCTATTRIBUTE_PICTURE_MODEL_KEY = "App.pres.productattribute.picture-{0}-{1}-{2}";
        public const string PRODUCTATTRIBUTE_PICTURE_PATTERN_KEY = "App.pres.productattribute.picture";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCTATTRIBUTE_IMAGESQUARE_PICTURE_MODEL_KEY = "App.pres.productattribute.imagesquare.picture-{0}-{1}-{2}";
        public const string PRODUCTATTRIBUTE_IMAGESQUARE_PICTURE_PATTERN_KEY = "App.pres.productattribute.imagesquare.picture";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string CATEGORY_PICTURE_MODEL_KEY = "App.pres.category.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CATEGORY_PICTURE_PATTERN_KEY = "App.pres.category.picture";
        public const string CATEGORY_PICTURE_PATTERN_KEY_BY_ID = "App.pres.category.picture-{0}-";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string MANUFACTURER_PICTURE_MODEL_KEY = "App.pres.manufacturer.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string MANUFACTURER_PICTURE_PATTERN_KEY = "App.pres.manufacturer.picture";
        public const string MANUFACTURER_PICTURE_PATTERN_KEY_BY_ID = "App.pres.manufacturer.picture-{0}-";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string VENDOR_PICTURE_MODEL_KEY = "App.pres.vendor.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string VENDOR_PICTURE_PATTERN_KEY = "App.pres.vendor.picture";
        public const string VENDOR_PICTURE_PATTERN_KEY_BY_ID = "App.pres.vendor.picture-{0}-";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string CART_PICTURE_MODEL_KEY = "App.pres.cart.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CART_PICTURE_PATTERN_KEY = "App.pres.cart.picture";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string HOMEPAGE_POLLS_MODEL_KEY = "App.pres.poll.homepage-{0}-{1}";
        /// <summary>
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string POLL_BY_SYSTEMNAME_MODEL_KEY = "App.pres.poll.systemname-{0}-{1}-{2}";
        public const string POLLS_PATTERN_KEY = "App.pres.poll";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string BLOG_TAGS_MODEL_KEY = "App.pres.blog.tags-{0}-{1}";
        /// <summary>
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string BLOG_MONTHS_MODEL_KEY = "App.pres.blog.months-{0}-{1}";
        public const string BLOG_PATTERN_KEY = "App.pres.blog";
        /// <summary>
        ...
        /// </remarks>
        public const string BLOG_COMMENTS_NUMBER_KEY = "App.pres.blog.comments.number-{0}-{1}-{2}";
        public const string BLOG_COMMENTS_PATTERN_KEY = "App.pres.blog.comments";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string HOMEPAGE_NEWSMODEL_KEY = "App.pres.news.homepage-{0}-{1}";
        public const string NEWS_PATTERN_KEY = "App.pres.news";
        /// <summary>
        ...
        /// {2} : are only approved comments?
        /// </remarks>
        public const string NEWS_COMMENTS_NUMBER_KEY = "App.pres.news.comments.number-{0}-{1}-{2}";
        public const string NEWS_COMMENTS_PATTERN_KEY = "App.pres.news.comments";
        ...
        /// {2} : language ID
        /// </remarks>
        public const string STATEPROVINCES_BY_COUNTRY_MODEL_KEY = "App.pres.stateprovinces.bycountry-{0}-{1}-{2}";
        public const string STATEPROVINCES_PATTERN_KEY = "App.pres.stateprovinces";
        ...
        /// {0} : language ID
        /// </remarks>
        public const string RETURNREQUESTREASONS_MODEL_KEY = "App.pres.returnrequesreasons-{0}";
        public const string RETURNREQUESTREASONS_PATTERN_KEY = "App.pres.returnrequesreasons";
        ...
        /// {0} : language ID
        /// </remarks>
        public const string RETURNREQUESTACTIONS_MODEL_KEY = "App.pres.returnrequestactions-{0}";
        public const string RETURNREQUESTACTIONS_PATTERN_KEY = "App.pres.returnrequestactions";
        ...
        /// </remarks>
        public const string STORE_LOGO_PATH = "App.pres.logo-{0}-{1}-{2}";
        public const string STORE_LOGO_PATH_PATTERN_KEY = "App.pres.logo";
        ...
        /// {0} : current store ID
        /// </remarks>
        public const string AVAILABLE_LANGUAGES_MODEL_KEY = "App.pres.languages.all-{0}";
        public const string AVAILABLE_LANGUAGES_PATTERN_KEY = "App.pres.languages";
        ...
        /// {1} : current store ID
        /// </remarks>
        public const string AVAILABLE_CURRENCIES_MODEL_KEY = "App.pres.currencies.all-{0}-{1}";
        public const string AVAILABLE_CURRENCIES_PATTERN_KEY = "App.pres.currencies";
        ...
        /// </remarks>
        public const string CHECKOUTATTRIBUTES_EXIST_KEY = "App.pres.checkoutattributes.exist-{0}-{1}";
        public const string CHECKOUTATTRIBUTES_PATTERN_KEY = "App.pres.checkoutattributes";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string SITEMAP_PAGE_MODEL_KEY = "App.pres.sitemap.page-{0}-{1}-{2}";
        /// <summary>
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string SITEMAP_SEO_MODEL_KEY = "App.pres.sitemap.seo-{0}-{1}-{2}-{3}";
        public const string SITEMAP_PATTERN_KEY = "App.pres.sitemap";
        ...
        /// </remarks>
        public const string WIDGET_MODEL_KEY = "App.pres.widget-{0}-{1}-{2}-{3}";
        public const string WIDGET_PATTERN_KEY = "App.pres.widget";
