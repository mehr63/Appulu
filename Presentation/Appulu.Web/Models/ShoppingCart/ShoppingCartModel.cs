...
namespace Appulu.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseAppModel
    {
        ...
        public partial class CheckoutAttributeValueModel : BaseAppEntityModel
        {
            public string Name { get; set; }
        ...
        public partial class DiscountBoxModel: BaseAppModel
        {
            ...
            public class DiscountInfoModel : BaseAppEntityModel
            {
                public string CouponCode { get; set; }
            }
        }

        public partial class GiftCardBoxModel : BaseAppModel
        {
            public bool Display { get; set; }
        ...
        public partial class OrderReviewDataModel : BaseAppModel
        {
