...
namespace Appulu.Web.Areas.Admin.Infrastructure.Cache
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Key for Appulu.com news cache
        /// </summary>
        public const string OFFICIAL_NEWS_MODEL_KEY = "App.pres.admin.official.news";
        public const string OFFICIAL_NEWS_PATTERN_KEY = "App.pres.admin.official.news";
        
        /// <summary>
        /// Key for specification attributes caching (product details page)
        /// </summary>
        public const string SPEC_ATTRIBUTES_MODEL_KEY = "App.pres.admin.product.specs";
        public const string SPEC_ATTRIBUTES_PATTERN_KEY = "App.pres.admin.product.specs";
        ...
        /// </remarks>
        public const string CATEGORIES_LIST_KEY = "App.pres.admin.categories.list-{0}";
        public const string CATEGORIES_LIST_PATTERN_KEY = "App.pres.admin.categories.list";
        ...
        /// {0} : show hidden records?
        /// </remarks>
        public const string MANUFACTURERS_LIST_KEY = "App.pres.admin.manufacturers.list-{0}";
        public const string MANUFACTURERS_LIST_PATTERN_KEY = "App.pres.admin.manufacturers.list";
        ...
        /// {0} : show hidden records?
        /// </remarks>
        public const string VENDORS_LIST_KEY = "App.pres.admin.vendors.list-{0}";
        public const string VENDORS_LIST_PATTERN_KEY = "App.pres.admin.vendors.list";
