...
namespace Appulu.Web.Areas.Admin.Models.Settings
{
    ...
    /// </summary>
    public partial class CaptchaSettingsModel : BaseAppModel, ISettingsModel
    {
        #region Properties
        ...
        [AppResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.CaptchaShowOnEmailProductToFriendPage")]
        ...
        [AppResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.CaptchaShowOnProductReviewPage")]
        public bool ShowOnProductReviewPage { get; set; }
        public bool ShowOnProductReviewPage_OverrideForStore { get; set; }

        [AppResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.CaptchaShowOnApplyVendorPage")]
