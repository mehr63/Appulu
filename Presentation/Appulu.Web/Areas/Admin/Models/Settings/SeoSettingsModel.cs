...
namespace Appulu.Web.Areas.Admin.Models.Settings
{
    ...
    /// </summary>
    public partial class SeoSettingsModel : BaseAppModel, ISettingsModel
    {
        #region Properties
        ...
        [AppResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.GenerateProductMetaDescription")]
        ...
        [AppResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.EnableJsBundling")]
        public bool EnableJsBundling { get; set; }
        public bool EnableJsBundling_OverrideForStore { get; set; }

        [AppResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.EnableCssBundling")]
