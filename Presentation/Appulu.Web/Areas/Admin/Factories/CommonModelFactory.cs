...
namespace Appulu.Web.Areas.Admin.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        /// </remarks>
        private const string APPULU_WARNING_URL = "https://www.Appulu.com/SiteWarnings.aspx?local={0}&url={1}";
        ...
        protected virtual void PrepareRemovalKeyWarningModel(IList<SystemWarningModel> models)
        {
            ...
            try
            {
                using (var client = new HttpClient())
                {
                    ...
                    var url = string.Format(APPULU_WARNING_URL, local, currentStoreUrl);
        ...
        public virtual SystemInfoModel PrepareSystemInfoModel(SystemInfoModel model)
        {
            ...
            model.AppVersion = AppVersion.CurrentVersion;
        ...
        public virtual CommonStatisticsModel PrepareCommonStatisticsModel()
        {
            ...
            var userRoleIds = new[] { _userService.GetUserRoleBySystemName(AppUserDefaults.RegisteredRoleName).Id };
