...
namespace Appulu.Web.Areas.Admin.Factories
{
    ...
    public partial class RecurringPaymentModelFactory : IRecurringPaymentModelFactory
    {
            ...
            var model = new RecurringPaymentListModel
            {
                Data = recurringPayments.Select(recurringPayment =>
                {
                    ...
                    var recurringPaymentModel = new RecurringPaymentModel
                    {
                        ...
                        UserId = recurringPayment.InitialOrder.UserId
                    };
                    ...
                    recurringPaymentModel.UserEmail = recurringPayment.InitialOrder.User.IsRegistered()
                        ? recurringPayment.InitialOrder.User.Email : _localizationService.GetResource("Admin.Users.Guest");
            ...
            RecurringPayment recurringPayment, bool excludeProperties = false)
        {
            ...
            model.UserEmail = recurringPayment.InitialOrder.User.IsRegistered()
                ? recurringPayment.InitialOrder.User.Email : _localizationService.GetResource("Admin.Users.Guest");
