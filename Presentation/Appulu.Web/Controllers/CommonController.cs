...
namespace Appulu.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        //available even when navigation is not allowed
        [CheckAccessPublicStore(true)]
        public virtual IActionResult SetTaxType(int userTaxType, string returnUrl = "")
        {
        ...
        public virtual IActionResult EuCookieLawAccept()
        {
            ...
            //save setting
            _genericAttributeService.SaveAttribute(_workContext.CurrentUser, AppUserDefaults.EuCookieLawAcceptedAttribute, true, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult InternalRedirect(string url, bool permanentRedirect)
        {
            ...
            if (HttpContext.Items["app.RedirectFromGenericPathRoute"] == null ||
                !Convert.ToBoolean(HttpContext.Items["app.RedirectFromGenericPathRoute"]))
            {
