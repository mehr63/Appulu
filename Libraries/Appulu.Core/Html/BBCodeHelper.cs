...
using Appulu.Core.Html.CodeFormatter;
using Appulu.Core.Infrastructure;

namespace Appulu.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the URL tags: [url=https://www.appulu.com]my site[/url]
                // becomes: <a href="https://www.appulu.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]https://www.appulu.com[/url]
                // becomes: <a href="https://www.appulu.com">https://www.appulu.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.appulu.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.appulu.com/Content/Images/Image.jpg">
