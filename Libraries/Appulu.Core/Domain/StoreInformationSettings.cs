...
namespace Appulu.Core.Domain
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether "powered by appulu" text should be displayed.
        /// Please find more info at https://www.appulu.net/copyrightremoval.aspx
        /// </summary>
