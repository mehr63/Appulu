...
namespace Appulu.Core.Domain.Common
{
    ...
    public class CommonSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether we should support previous appulu versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousAppuluVersions { get; set; }
