...
using Appulu.Core.Infrastructure.Mapper;
using Appulu.Core.Plugins;

namespace Appulu.Core.Infrastructure
{
    /// <summary>
    ...
    public class AppEngine : IEngine
    {
        ...
        /// <param name="typeFinder">Type finder</param>
        protected virtual IServiceProvider RegisterDependencies(AppConfig appConfig, IServiceCollection services, ITypeFinder typeFinder)
        {
