...
namespace Appulu.Data.Mapping.Common
{
    ...
    /// </summary>
    public partial class AddressAttributeValueMap : AppEntityTypeConfiguration<AddressAttributeValue>
    {
        #region Methods
        ...
        {
            builder.ToTable(nameof(AddressAttributeValue), Schemas.Common);
