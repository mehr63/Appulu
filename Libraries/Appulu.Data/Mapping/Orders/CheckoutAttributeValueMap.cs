...
namespace Appulu.Data.Mapping.Orders
{
    ...
    /// </summary>
    public partial class CheckoutAttributeValueMap : AppEntityTypeConfiguration<CheckoutAttributeValue>
    {
        #region Methods
        ...
        {
            builder.ToTable(nameof(CheckoutAttributeValue), Schemas.Orders);
