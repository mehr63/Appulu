...
namespace Appulu.Data.Mapping.Orders
{
    ...
    /// </summary>
    public partial class RecurringPaymentHistoryMap : AppEntityTypeConfiguration<RecurringPaymentHistory>
    {
        #region Methods
        ...
        {
            builder.ToTable(nameof(RecurringPaymentHistory), Schemas.Orders);
