...
namespace Appulu.Data.Mapping.Catalog
{
    ...
    /// </summary>
    public partial class ProductAttributeValueMap : AppEntityTypeConfiguration<ProductAttributeValue>
    {
        #region Methods
        ...
        {
            builder.ToTable(nameof(ProductAttributeValue), Schemas.Catalog);
