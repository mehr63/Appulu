...
namespace Appulu.Data.Mapping.Catalog
{
    ...
    /// </summary>
    public partial class SpecificationAttributeMap : AppEntityTypeConfiguration<SpecificationAttribute>
    {
        #region Methods
        ...
        {
            builder.ToTable(nameof(SpecificationAttribute), Schemas.Catalog);
