...
namespace Appulu.Data.Mapping.Catalog
{
    ...
    /// </summary>
    public partial class ProductAttributeMappingMap : AppEntityTypeConfiguration<ProductAttributeMapping>
    {
        #region Methods
        ...
        {
            builder.ToTable(AppMappingDefaults.ProductProductAttributeTable, Schemas.Catalog);
