...
namespace Appulu.Data.Mapping.Catalog
{
    ...
    /// </summary>
    public partial class ProductSpecificationAttributeMap : AppEntityTypeConfiguration<ProductSpecificationAttribute>
    {
        #region Methods
        ...
        {
            builder.ToTable(AppMappingDefaults.ProductSpecificationAttributeTable, Schemas.Catalog);
