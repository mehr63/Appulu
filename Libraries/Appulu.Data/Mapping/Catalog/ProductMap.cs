...
namespace Appulu.Data.Mapping.Catalog
{
    ...
    public partial class ProductMap : AppEntityTypeConfiguration<Product>
    {
        ...
        public override void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(product => product.MinimumUserEnteredPrice).HasColumnType("decimal(18, 4)");
            builder.Property(product => product.MaximumUserEnteredPrice).HasColumnType("decimal(18, 4)");
