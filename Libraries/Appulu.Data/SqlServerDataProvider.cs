...
namespace Appulu.Data
{
    ...
    public partial class SqlServerDataProvider : IDataProvider
    {
        ...
        public virtual void InitializeDatabase()
        {
            ...
            //check some of table names to ensure that we have Appulu 2.00+ installed
            ...
            //create indexes
            context.ExecuteSqlScriptFromFile(fileProvider.MapPath(AppDataDefaults.SqlServerIndexesFilePath));

            //create stored procedures 
            context.ExecuteSqlScriptFromFile(fileProvider.MapPath(AppDataDefaults.SqlServerStoredProceduresFilePath));
        }
