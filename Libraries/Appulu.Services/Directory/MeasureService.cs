...
namespace Appulu.Services.Directory
{
    ...
    public partial class MeasureService : IMeasureService
    {
        ...
        public virtual void DeleteMeasureDimension(MeasureDimension measureDimension)
        {
            ...
            _cacheManager.RemoveByPattern(AppDirectoryDefaults.MeasureDimensionsPatternCacheKey);
        ...
        public virtual MeasureDimension GetMeasureDimensionById(int measureDimensionId)
        {
            ...
            var key = string.Format(AppDirectoryDefaults.MeasureDimensionsByIdCacheKey, measureDimensionId);
        ...
        {
            return _cacheManager.Get(AppDirectoryDefaults.MeasureDimensionsAllCacheKey, () =>
            {
        ...
        public virtual void DeleteMeasureWeight(MeasureWeight measureWeight)
        {
            ...
            _cacheManager.RemoveByPattern(AppDirectoryDefaults.MeasureWeightsPatternCacheKey);
        ...
        public virtual MeasureWeight GetMeasureWeightById(int measureWeightId)
        {
            ...
            var key = string.Format(AppDirectoryDefaults.MeasureWeightsByIdCacheKey, measureWeightId);
        ...
        {
            return _cacheManager.Get(AppDirectoryDefaults.MeasureWeightsAllCacheKey, () =>
            {
