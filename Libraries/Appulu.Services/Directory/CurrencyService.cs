...
namespace Appulu.Services.Directory
{
    ...
    public partial class CurrencyService : ICurrencyService
    {
        ...
        public virtual void DeleteCurrency(Currency currency)
        {
            ...
            _cacheManager.RemoveByPattern(AppDirectoryDefaults.CurrenciesPatternCacheKey);
        ...
        public virtual Currency GetCurrencyById(int currencyId, bool loadCacheableCopy = true)
        {
            ...
            //cacheable copy
            var key = string.Format(AppDirectoryDefaults.CurrenciesByIdCacheKey, currencyId);
        ...
        public virtual IList<Currency> GetAllCurrencies(bool showHidden = false, int storeId = 0, bool loadCacheableCopy = true)
        {
            ...
            {
                //cacheable copy
                var key = string.Format(AppDirectoryDefaults.CurrenciesAllCacheKey, showHidden);
