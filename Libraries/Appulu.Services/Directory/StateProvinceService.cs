...
namespace Appulu.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        public virtual void DeleteStateProvince(StateProvince stateProvince)
        {
            ...
            _cacheManager.RemoveByPattern(AppDirectoryDefaults.StateProvincesPatternCacheKey);
        ...
        {
            var key = string.Format(AppDirectoryDefaults.StateProvincesAllCacheKey, countryId, languageId, showHidden);
