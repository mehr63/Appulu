...
namespace Appulu.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        public virtual void DeleteCountry(Country country)
        {
            ...
            _cacheManager.RemoveByPattern(AppDirectoryDefaults.CountriesPatternCacheKey);
        ...
        {
            var key = string.Format(AppDirectoryDefaults.CountriesAllCacheKey, languageId, showHidden);
