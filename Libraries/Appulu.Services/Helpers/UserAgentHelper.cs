...
namespace Appulu.Services.Helpers
{
    /// <summary>
    /// User agent helper
    /// </summary>
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        protected virtual BrowscapXmlHelper GetBrowscapXmlHelper()
        {
            ...
            //no database created
            if (string.IsNullOrEmpty(_appConfig.UserAgentStringsPath))
                return null;
            ...
            lock (_locker)
            {
                ...
                var userAgentStringsPath = _fileProvider.MapPath(_appConfig.UserAgentStringsPath);
                var crawlerOnlyUserAgentStringsPath = !string.IsNullOrEmpty(_appConfig.CrawlerOnlyUserAgentStringsPath)
                    ? _fileProvider.MapPath(_appConfig.CrawlerOnlyUserAgentStringsPath)
                    : string.Empty;
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            //more info: https://www.Appulu.com/boards/t/17711/unhandled-exception-request-is-not-available-in-this-context.aspx
            try
            {
