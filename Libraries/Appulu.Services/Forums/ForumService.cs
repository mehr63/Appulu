...
namespace Appulu.Services.Forums
{
    ...
    public partial class ForumService : IForumService
    {
        ...
        private void UpdateUserStats(int userId)
        {
            ...
            _genericAttributeService.SaveAttribute(user, AppUserDefaults.ForumPostCountAttribute, numPosts);
        }
        ...
        public virtual void DeleteForumGroup(ForumGroup forumGroup)
        {
            ...
            _cacheManager.RemoveByPattern(AppForumDefaults.ForumGroupPatternCacheKey);
            _cacheManager.RemoveByPattern(AppForumDefaults.ForumPatternCacheKey);
        ...
        {
            return _cacheManager.Get(AppForumDefaults.ForumGroupAllCacheKey, () =>
            {
        ...
        {
            var key = string.Format(AppForumDefaults.ForumAllByForumGroupIdCacheKey, forumGroupId);
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            //UI notification
            _genericAttributeService.SaveAttribute(userTo, AppUserDefaults.NotifiedAboutNewPrivateMessagesAttribute, false, privateMessage.StoreId);
