...
namespace Appulu.Services.Vendors
{
    ...
    public partial class VendorAttributeService : IVendorAttributeService
    {
        ...
        {
            return _cacheManager.Get(AppVendorsServiceDefaults.VendorAttributesAllCacheKey, () =>
            {
        ...
        public virtual VendorAttribute GetVendorAttributeById(int vendorAttributeId)
        {
            ...
            var key = string.Format(AppVendorsServiceDefaults.VendorAttributesByIdCacheKey, vendorAttributeId);
        ...
        public virtual void InsertVendorAttribute(VendorAttribute vendorAttribute)
        {
            ...
            _cacheManager.RemoveByPattern(AppVendorsServiceDefaults.VendorAttributesPatternCacheKey);
            _cacheManager.RemoveByPattern(AppVendorsServiceDefaults.VendorAttributeValuesPatternCacheKey);
        ...
        {
            var key = string.Format(AppVendorsServiceDefaults.VendorAttributeValuesAllCacheKey, vendorAttributeId);
        ...
        public virtual VendorAttributeValue GetVendorAttributeValueById(int vendorAttributeValueId)
        {
            ...
            var key = string.Format(AppVendorsServiceDefaults.VendorAttributeValuesByIdCacheKey, vendorAttributeValueId);
