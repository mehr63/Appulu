namespace Appulu.Services.Seo
{
    ...
    public static partial class AppSeoDefaults
    {
        ...
        /// {2} : language ID
        /// </remarks>
        public static string UrlRecordActiveByIdNameLanguageCacheKey => "App.urlrecord.active.id-name-language-{0}-{1}-{2}";

        /// <summary>
        /// Gets a key for caching
        /// </summary>
        public static string UrlRecordAllCacheKey => "App.urlrecord.all";
        ...
        /// {0} : slug
        /// </remarks>
        public static string UrlRecordBySlugCacheKey => "App.urlrecord.active.slug-{0}";

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string UrlRecordPatternCacheKey => "App.urlrecord.";
