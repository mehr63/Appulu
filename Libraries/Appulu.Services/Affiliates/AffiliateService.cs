...
namespace Appulu.Services.Affiliates
{
    /// <summary>
    /// Affiliate service
    /// </summary>
    public partial class AffiliateService : IAffiliateService
    {
        ...
        public virtual string GenerateUrl(Affiliate affiliate)
        {
            ...
            var url = !string.IsNullOrEmpty(affiliate.FriendlyUrlName) ?
                //use friendly URL
                _webHelper.ModifyQueryString(storeUrl, AppAffiliateDefaults.AffiliateQueryParameter, affiliate.FriendlyUrlName) :
                //use ID
                _webHelper.ModifyQueryString(storeUrl, AppAffiliateDefaults.AffiliateIdQueryParameter, affiliate.Id.ToString());
        ...
        public virtual string ValidateFriendlyUrlName(Affiliate affiliate, string friendlyUrlName)
        {
            ...
            friendlyUrlName = CommonHelper.EnsureMaximumLength(friendlyUrlName, AppAffiliateDefaults.FriendlyUrlNameLength);
