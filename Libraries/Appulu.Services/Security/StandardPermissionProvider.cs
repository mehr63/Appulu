    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public virtual IEnumerable<DefaultPermissionRecord> GetDefaultPermissions()
        {
            return new[] 
            {
                ...
                {
                    UserRoleSystemName = AppUserDefaults.AdministratorsRoleName,
                ...
                new DefaultPermissionRecord 
                {
                    UserRoleSystemName = AppUserDefaults.ForumModeratorsRoleName,
                    PermissionRecords = new[] 
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord 
                {
                    UserRoleSystemName = AppUserDefaults.GuestsRoleName,
                    PermissionRecords = new[] 
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord 
                {
                    UserRoleSystemName = AppUserDefaults.RegisteredRoleName,
                    PermissionRecords = new[] 
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord 
                {
                    UserRoleSystemName = AppUserDefaults.VendorsRoleName,
                    PermissionRecords = new[] 
                    {
                        AccessAdminPanel,
                        ManageProducts,
