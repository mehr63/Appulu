...
namespace Appulu.Services.Security
{
    ...
    public partial class PermissionService : IPermissionService
    {
        ...
        {
            var key = string.Format(AppSecurityDefaults.PermissionsAllByUserRoleIdCacheKey, userRoleId);
        ...
        protected virtual bool Authorize(string permissionRecordSystemName, int userRoleId)
        {
            ...
            var key = string.Format(AppSecurityDefaults.PermissionsAllowedCacheKey, userRoleId, permissionRecordSystemName);
        ...
        public virtual void DeletePermissionRecord(PermissionRecord permission)
        {
            ...
            _cacheManager.RemoveByPattern(AppSecurityDefaults.PermissionsPatternCacheKey);
            _staticCacheManager.RemoveByPattern(AppSecurityDefaults.PermissionsPatternCacheKey);
        }
