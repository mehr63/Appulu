...
namespace Appulu.Services.Security
{
    ...
    public partial class AclService : IAclService
    {
        ...
        public virtual void DeleteAclRecord(AclRecord aclRecord)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(AppSecurityDefaults.AclRecordPatternCacheKey);
        ...
        public virtual int[] GetUserRoleIdsWithAccess<T>(T entity) where T : BaseEntity, IAclSupported
        {
            ...
            var key = string.Format(AppSecurityDefaults.AclRecordByEntityIdNameCacheKey, entityId, entityName);
