...
namespace Appulu.Services.Users
{
    ...
    public partial class UserAttributeService : IUserAttributeService
    {
        ...
        public virtual void DeleteUserAttribute(UserAttribute userAttribute)
        {
            ...
            _cacheManager.RemoveByPattern(AppUserServiceDefaults.UserAttributesPatternCacheKey);
            _cacheManager.RemoveByPattern(AppUserServiceDefaults.UserAttributeValuesPatternCacheKey);
        ...
        {
            return _cacheManager.Get(AppUserServiceDefaults.UserAttributesAllCacheKey, () =>
            {
        ...
        public virtual UserAttribute GetUserAttributeById(int userAttributeId)
        {
            ...
            var key = string.Format(AppUserServiceDefaults.UserAttributesByIdCacheKey, userAttributeId);
        ...
        {
            var key = string.Format(AppUserServiceDefaults.UserAttributeValuesAllCacheKey, userAttributeId);
        ...
        public virtual UserAttributeValue GetUserAttributeValueById(int userAttributeValueId)
        {
            ...
            var key = string.Format(AppUserServiceDefaults.UserAttributeValuesByIdCacheKey, userAttributeValueId);
