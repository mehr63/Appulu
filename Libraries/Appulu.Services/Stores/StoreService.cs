...
namespace Appulu.Services.Stores
{
    ...
    public partial class StoreService : IStoreService
    {
        ...
        public virtual void DeleteStore(Store store)
        {
            ...
            _cacheManager.RemoveByPattern(AppStoreDefaults.StoresPatternCacheKey);
        ...
        public virtual IList<Store> GetAllStores(bool loadCacheableCopy = true)
        {
            ...
            {
                //cacheable copy
                return _cacheManager.Get(AppStoreDefaults.StoresAllCacheKey, () =>
                {
        ...
        public virtual Store GetStoreById(int storeId, bool loadCacheableCopy = true)
        {
            ...
            //cacheable copy
            var key = string.Format(AppStoreDefaults.StoresByIdCacheKey, storeId);
