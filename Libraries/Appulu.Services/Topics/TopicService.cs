...
namespace Appulu.Services.Topics
{
    ...
    public partial class TopicService : ITopicService
    {
        ...
        public virtual void DeleteTopic(Topic topic)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(AppTopicDefaults.TopicsPatternCacheKey);
        ...
        public virtual Topic GetTopicById(int topicId)
        {
            ...
            var key = string.Format(AppTopicDefaults.TopicsByIdCacheKey, topicId);
        ...
        {
            var key = string.Format(AppTopicDefaults.TopicsAllCacheKey, storeId, ignorAcl, showHidden);
