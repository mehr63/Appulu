...
namespace Appulu.Services.Media
{
    /// <summary>
    /// Picture service
    /// </summary>
    public partial class PictureService : IPictureService
    {
            ...
            ResizeType resizeType = ResizeType.LongestSide, bool ensureSizePositive = true)
        {
            ...
            //we invoke Math.Round to ensure that no white background is rendered - https://www.Appulu.com/boards/t/40616/image-resizing-bug.aspx
            return new Size((int)Math.Round(width), (int)Math.Round(height));
        }
        ...
        protected virtual string GetThumbLocalPath(string thumbFileName)
        {
            ...
            if (_mediaSettings.MultipleThumbDirectories)
            {
                ...
                {
                    var subDirectoryName = fileNameWithoutExtension.Substring(0, AppMediaDefaults.MultipleThumbDirectoriesLength);
            ...
            string storeLocation = null)
        {
            ...
            switch (defaultPictureType)
            {
                case PictureType.Avatar:
                    defaultImageFileName = _settingService.GetSettingByKey("Media.User.DefaultAvatarImageName", AppMediaDefaults.DefaultAvatarFileName);
                    break;
                case PictureType.Entity:
                default:
                    defaultImageFileName = _settingService.GetSettingByKey("Media.DefaultImageName", AppMediaDefaults.DefaultImageFileName);
                    break;
            }
