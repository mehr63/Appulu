...
namespace Appulu.Services.Installation
{
    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual string ValidateSeName<T>(T entity, string name) where T : BaseEntity
        {
            ...
            //max length
            name = CommonHelper.EnsureMaximumLength(name, AppSeoDefaults.SearchEngineNameLength);
        ...
        protected virtual void InstallUsersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            ...
            var crVendors = new UserRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = AppUserDefaults.VendorsRoleName
            };
            ...
            adminUser.UserUserRoleMappings.Add(new UserUserRoleMapping { UserRole = crAdministrators });
            adminUser.UserUserRoleMappings.Add(new UserUserRoleMapping { UserRole = crForumModerators });
            adminUser.UserUserRoleMappings.Add(new UserUserRoleMapping { UserRole = crRegistered });

            _userRepository.Insert(adminUser);
            //set default user name
            _genericAttributeService.SaveAttribute(adminUser, AppUserDefaults.FirstNameAttribute, "John");
            _genericAttributeService.SaveAttribute(adminUser, AppUserDefaults.LastNameAttribute, "Smith");
            ...
            //second user
            var secondUserEmail = "steve_gates@Appulu.com";
            ...
            secondUser.UserUserRoleMappings.Add(new UserUserRoleMapping { UserRole = crRegistered });

            _userRepository.Insert(secondUser);
            //set default user name
            _genericAttributeService.SaveAttribute(secondUser, AppUserDefaults.FirstNameAttribute, defaultSecondUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(secondUser, AppUserDefaults.LastNameAttribute, defaultSecondUserAddress.LastName);
            ...
            //third user
            var thirdUserEmail = "arthur_holmes@Appulu.com";
            ...
            thirdUser.UserUserRoleMappings.Add(new UserUserRoleMapping { UserRole = crRegistered });

            _userRepository.Insert(thirdUser);
            //set default user name
            _genericAttributeService.SaveAttribute(thirdUser, AppUserDefaults.FirstNameAttribute, defaultThirdUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(thirdUser, AppUserDefaults.LastNameAttribute, defaultThirdUserAddress.LastName);
            ...
            //fourth user
            var fourthUserEmail = "james_pan@Appulu.com";
            ...
            fourthUser.UserUserRoleMappings.Add(new UserUserRoleMapping { UserRole = crRegistered });

            _userRepository.Insert(fourthUser);
            //set default user name
            _genericAttributeService.SaveAttribute(fourthUser, AppUserDefaults.FirstNameAttribute, defaultFourthUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(fourthUser, AppUserDefaults.LastNameAttribute, defaultFourthUserAddress.LastName);
            ...
            //fifth user
            var fifthUserEmail = "brenda_lindgren@Appulu.com";
            ...
            fifthUser.UserUserRoleMappings.Add(new UserUserRoleMapping { UserRole = crRegistered });

            _userRepository.Insert(fifthUser);
            //set default user name
            _genericAttributeService.SaveAttribute(fifthUser, AppUserDefaults.FirstNameAttribute, defaultFifthUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(fifthUser, AppUserDefaults.LastNameAttribute, defaultFifthUserAddress.LastName);
            ...
            //sixth user
            var sixthUserEmail = "victoria_victoria@Appulu.com";
            ...
            sixthUser.UserUserRoleMappings.Add(new UserUserRoleMapping { UserRole = crRegistered });

            _userRepository.Insert(sixthUser);
            //set default user name
            _genericAttributeService.SaveAttribute(sixthUser, AppUserDefaults.FirstNameAttribute, defaultSixthUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(sixthUser, AppUserDefaults.LastNameAttribute, defaultSixthUserAddress.LastName);
            ...
            searchEngineUser.UserUserRoleMappings.Add(new UserUserRoleMapping { UserRole = crGuests });
            ...
            backgroundTaskUser.UserUserRoleMappings.Add(new UserUserRoleMapping { UserRole = crGuests });
        ...
        protected virtual void InstallOrders()
        {
            ...
            //first order
            var firstUser = _userRepository.Table.First(c => c.Email.Equals("steve_gates@Appulu.com"));
            var firstOrder = new Order
            {
                ...
                BillingAddress = (Address)firstUser.BillingAddress.Clone(),
                ShippingAddress = (Address)firstUser.ShippingAddress.Clone(),
            ...
            var firstOrderItem3 = new OrderItem
            {
                ...
                PriceExclTax = 25M,
                OriginalProductCost = decimal.Zero,
                AttributeDescription = "From: Steve Gates &lt;steve_gates@Appulu.com&gt;<br />For: Brenda Lindgren &lt;brenda_lindgren@Appulu.com&gt;",
                AttributesXml = "<Attributes><GiftCardInfo><RecipientName>Brenda Lindgren</RecipientName><RecipientEmail>brenda_lindgren@Appulu.com</RecipientEmail><SenderName>Steve Gates</SenderName><SenderEmail>steve_gates@gmail.com</SenderEmail><Message></Message></GiftCardInfo></Attributes>",
                Quantity = 1,
                DiscountAmountInclTax = decimal.Zero,
                DiscountAmountExclTax = decimal.Zero,
                DownloadCount = 0,
            ...
            var firstOrderGiftcard = new GiftCard
            {
                ...
                RecipientEmail = "brenda_lindgren@Appulu.com",
                SenderName = "Steve Gates",
                SenderEmail = "steve_gates@Appulu.com",
            ...
            //second order
            var secondUser = _userRepository.Table.First(c => c.Email.Equals("arthur_holmes@Appulu.com"));
            var secondOrder = new Order
            {
                ...
                PaidDateUtc = null,
                BillingAddress = (Address)secondUser.BillingAddress.Clone(),
                ShippingAddress = (Address)secondUser.ShippingAddress.Clone(),
                ShippingStatus = ShippingStatus.NotYetShipped,
            ...
            //third order
            var thirdUser = _userRepository.Table.First(c => c.Email.Equals("james_pan@Appulu.com"));
            var thirdOrder = new Order
            {
                ...
                PaymentStatus = PaymentStatus.Pending,
                PaidDateUtc = null,
                BillingAddress = (Address)thirdUser.BillingAddress.Clone(),
            ...
            //fourth order
            var fourthUser = _userRepository.Table.First(c => c.Email.Equals("brenda_lindgren@Appulu.com"));
            var fourthOrder = new Order
            {
                ...
                PaymentStatus = PaymentStatus.Paid,
                PaidDateUtc = DateTime.UtcNow,
                BillingAddress = (Address)fourthUser.BillingAddress.Clone(),
                ShippingAddress = (Address)fourthUser.ShippingAddress.Clone(),
                ShippingStatus = ShippingStatus.Shipped,
                ShippingMethod = "Pickup in store",
                PickUpInStore = true,
                PickupAddress = (Address)fourthUser.ShippingAddress.Clone(),
            ...
            //fifth order
            var fifthUser = _userRepository.Table.First(c => c.Email.Equals("victoria_victoria@Appulu.com"));
            var fifthOrder = new Order
            {
                ...
                PaymentStatus = PaymentStatus.Paid,
                PaidDateUtc = DateTime.UtcNow,
                BillingAddress = (Address)fifthUser.BillingAddress.Clone(),
                ShippingAddress = (Address)fifthUser.ShippingAddress.Clone(),
        ...
        protected virtual void InstallSettings(bool installSampleData)
        {
            ...
            settingService.SaveSetting(new CommonSettings
            {
                ...
                SupportPreviousAppuluVersions = true,
            ...
            settingService.SaveSetting(new CatalogSettings
            {
                ...
                PageShareCode = "<!-- AddThis Button BEGIN --><div class=\"addthis_toolbox addthis_default_style \"><a class=\"addthis_button_preferred_1\"></a><a class=\"addthis_button_preferred_2\"></a><a class=\"addthis_button_preferred_3\"></a><a class=\"addthis_button_preferred_4\"></a><a class=\"addthis_button_compact\"></a><a class=\"addthis_counter addthis_bubble_style\"></a></div><script src=\"http://s7.addthis.com/js/250/addthis_widget.js#pubid=appulusolutions\"></script><!-- AddThis Button END -->",
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "http://www.facebook.com/Appulu",
                TwitterLink = "https://twitter.com/Appulu",
                YoutubeLink = "http://www.youtube.com/user/Appulu",
                GooglePlusLink = "https://plus.google.com/+Appulu",
                HidePoweredByAppulu = false
            });
        ...
        protected virtual void InstallNews(string defaultUserEmail)
        {
            ...
            var news = new List<NewsItem>
            {
                new NewsItem
                {
                    ...
                    Language = defaultLanguage,
                    Title = "About Appulu",
                    Short = "It's stable and highly usable. From downloads to documentation, www.Appulu.com offers a comprehensive base of information, resources, and support to the Appulu community.",
                    Full = "<p>For full feature list go to <a href=\"https://www.Appulu.com\">Appulu.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow
                },
                new NewsItem
                {
                    AllowComments = true,
                    Language = defaultLanguage,
                    Title = "Appulu new release!",
                    Short = "Appulu includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! Appulu is a fully customizable shopping cart",
                    Full = "<p>Appulu includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow.AddSeconds(1)
                },
                new NewsItem
                {
                    ...
                    Short = "The new Appulu store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                ...
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "App.Services.Users.DeleteGuestsTask, App.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
