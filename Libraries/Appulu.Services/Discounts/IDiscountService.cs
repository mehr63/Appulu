...
namespace Appulu.Services.Discounts
{
    ...
    public partial interface IDiscountService
    {
        ...
        IList<int> GetAppliedCategoryIds(DiscountForCaching discount, User user);
        ...
        IList<int> GetAppliedManufacturerIds(DiscountForCaching discount, User user);
        ...
        IList<IDiscountRequirementRule> LoadAllDiscountRequirementRules(User user = null);
        ...
        /// <param name="user">User</param>
        /// <returns>Discount validation result</returns>
        DiscountValidationResult ValidateDiscount(DiscountForCaching discount, User user);
        ...
        /// <param name="couponCodesToValidate">Coupon codes to validate</param>
        /// <returns>Discount validation result</returns>
        DiscountValidationResult ValidateDiscount(DiscountForCaching discount, User user, string[] couponCodesToValidate);
