...
namespace Appulu.Services.Shipping
{
    ...
    public partial interface IShippingService
    {
        ...
        IList<IShippingRateComputationMethod> LoadActiveShippingRateComputationMethods(User user = null, int storeId = 0);
        ...
        /// <param name="storeId">Load records allowed only in a specified store; pass 0 to load all records</param>
        /// <returns>Shipping rate computation methods</returns>
        IList<IShippingRateComputationMethod> LoadAllShippingRateComputationMethods(User user = null, int storeId = 0);
        ...
        IList<IPickupPointProvider> LoadActivePickupPointProviders(User user = null, int storeId = 0);
        ...
        /// <param name="storeId">Load records allowed only in a specified store; pass 0 to load all records</param>
        /// <returns>Pickup point providers</returns>
        IList<IPickupPointProvider> LoadAllPickupPointProviders(User user = null, int storeId = 0);
