...
namespace Appulu.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        public virtual void DeleteProductAttribute(ProductAttribute productAttribute)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ProductAttributesPatternCacheKey);
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ProductAttributeMappingsPatternCacheKey);
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ProductAttributeValuesPatternCacheKey);
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ProductAttributeCombinationsPatternCacheKey);
        ...
        {
            var key = string.Format(AppCatalogDefaults.ProductAttributesAllCacheKey, pageIndex, pageSize);
        ...
        public virtual ProductAttribute GetProductAttributeById(int productAttributeId)
        {
            ...
            var key = string.Format(AppCatalogDefaults.ProductAttributesByIdCacheKey, productAttributeId);
        ...
        {
            var key = string.Format(AppCatalogDefaults.ProductAttributeMappingsAllCacheKey, productId);
        ...
        public virtual ProductAttributeMapping GetProductAttributeMappingById(int productAttributeMappingId)
        {
            ...
            var key = string.Format(AppCatalogDefaults.ProductAttributeMappingsByIdCacheKey, productAttributeMappingId);
        ...
        {
            var key = string.Format(AppCatalogDefaults.ProductAttributeValuesAllCacheKey, productAttributeMappingId);
            return _cacheManager.Get(key, () =>
            {
        ...
        public virtual ProductAttributeValue GetProductAttributeValueById(int productAttributeValueId)
        {
            ...
            var key = string.Format(AppCatalogDefaults.ProductAttributeValuesByIdCacheKey, productAttributeValueId);
        ...
        public virtual IList<ProductAttributeCombination> GetAllProductAttributeCombinations(int productId)
        {
            ...
            var key = string.Format(AppCatalogDefaults.ProductAttributeCombinationsAllCacheKey, productId);
