...
namespace Appulu.Services.Catalog
{
    ...
    public partial class ManufacturerService : IManufacturerService
    {
        ...
        public virtual Manufacturer GetManufacturerById(int manufacturerId)
        {
            ...
            var key = string.Format(AppCatalogDefaults.ManufacturersByIdCacheKey, manufacturerId);
        ...
        public virtual void InsertManufacturer(Manufacturer manufacturer)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ManufacturersPatternCacheKey);
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ProductManufacturersPatternCacheKey);
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            ...
            var key = string.Format(AppCatalogDefaults.ProductManufacturersAllByManufacturerIdCacheKey, showHidden, manufacturerId, pageIndex, pageSize, _workContext.CurrentUser.Id, _storeContext.CurrentStore.Id);
        ...
        public virtual IList<ProductManufacturer> GetProductManufacturersByProductId(int productId, bool showHidden = false)
        {
            ...
            var key = string.Format(AppCatalogDefaults.ProductManufacturersAllByProductIdCacheKey, showHidden, productId, _workContext.CurrentUser.Id, _storeContext.CurrentStore.Id);
            return _cacheManager.Get(key, () =>
            {
                var query = from pm in _productManufacturerRepository.Table
                            join m in _manufacturerRepository.Table on pm.ManufacturerId equals m.Id
