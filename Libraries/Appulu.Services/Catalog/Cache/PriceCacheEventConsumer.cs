...
namespace Appulu.Services.Catalog.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<Order>>
    {
        ...
        {
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ProductPricePatternCacheKey);
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ProductCategoryIdsPatternCacheKey);
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ProductManufacturerIdsPatternCacheKey);
        }
