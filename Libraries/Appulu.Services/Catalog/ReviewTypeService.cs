...
namespace Appulu.Services.Catalog
{
    ...
    public partial class ReviewTypeService : IReviewTypeService
    {
        ...
        {
            return _cacheManager.Get(AppCatalogDefaults.ReviewTypeAllKey, () =>
            {
        ...
        public virtual ReviewType GetReviewTypeById(int reviewTypeId)
        {
            ...
            var key = string.Format(AppCatalogDefaults.ReviewTypeByIdKey, reviewTypeId);
        ...
        public virtual void InsertReviewType(ReviewType reviewType)
        {
            ...
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ReviewTypeByPatternKey);
        ...
        {
            var key = string.Format(AppCatalogDefaults.ProductReviewReviewTypeMappingAllKey, productReviewId);
