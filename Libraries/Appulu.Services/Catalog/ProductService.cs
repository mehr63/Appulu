...
namespace Appulu.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        public virtual Product GetProductById(int productId)
        {
            ...
            var key = string.Format(AppCatalogDefaults.ProductsByIdCacheKey, productId);
        ...
        public virtual void InsertProduct(Product product)
        {
            ...
            //clear cache
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ProductsPatternCacheKey);
            ...
            bool? overridePublished = null)
        {
            ...
            var pAllowedUserRoleIds = _dataProvider.GetStringParameter("AllowedUserRoleIds", !_catalogSettings.IgnoreAcl ? commaSeparatedAllowedUserRoleIds : string.Empty);
        ...
        public virtual IPagedList<ProductReview> GetAllProductReviews(int userId, bool? approved,
