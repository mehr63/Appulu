...
namespace Appulu.Services.Catalog
{
    ...
    public partial class ProductTagService : IProductTagService
    {
        ...
        {
            var key = string.Format(AppCatalogDefaults.ProductTagCountCacheKey, storeId);
        ...
        public virtual void DeleteProductTag(ProductTag productTag)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(AppCatalogDefaults.ProductTagPatternCacheKey);
            _staticCacheManager.RemoveByPattern(AppCatalogDefaults.ProductTagPatternCacheKey);
        ...
        {
            var key = string.Format(AppCatalogDefaults.ProductTagAllByProductIdCacheKey, productId);
