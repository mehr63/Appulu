...
namespace Appulu.Services.Localization
{
    ...
    public partial class LanguageService : ILanguageService
    {
        ...
        public virtual void DeleteLanguage(Language language)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(AppLocalizationDefaults.LanguagesPatternCacheKey);
        ...
        public virtual IList<Language> GetAllLanguages(bool showHidden = false, int storeId = 0, bool loadCacheableCopy = true)
        {
            ...
            {
                //cacheable copy
                var key = string.Format(AppLocalizationDefaults.LanguagesAllCacheKey, showHidden);
        ...
        public virtual Language GetLanguageById(int languageId, bool loadCacheableCopy = true)
        {
            ...
            //cacheable copy
            var key = string.Format(AppLocalizationDefaults.LanguagesByIdCacheKey, languageId);
