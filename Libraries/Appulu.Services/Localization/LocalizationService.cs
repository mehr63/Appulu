...
namespace Appulu.Services.Localization
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        protected virtual void InsertLocaleStringResources(IList<LocaleStringResource> resources)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(AppLocalizationDefaults.LocaleStringResourcesPatternCacheKey);
        ...
        {
            var key = string.Format(AppLocalizationDefaults.LocaleStringResourcesAllCacheKey, languageId);
            ...
            if (!loadPublicLocales.HasValue || _cacheManager.IsSet(key))
            {
                ...
                _cacheManager.Remove(string.Format(AppLocalizationDefaults.LocaleStringResourcesAllPublicCacheKey, languageId));
                _cacheManager.Remove(string.Format(AppLocalizationDefaults.LocaleStringResourcesAllAdminCacheKey, languageId));

                return rez;
            }

            //performance optimization of the site startup
            key = string.Format(loadPublicLocales.Value ? AppLocalizationDefaults.LocaleStringResourcesAllPublicCacheKey : AppLocalizationDefaults.LocaleStringResourcesAllAdminCacheKey, languageId);
            ...
            return _cacheManager.Get(key, () =>
            {
                ...
                var query = from l in _lsrRepository.TableNoTracking
                            ...
                            where l.LanguageId == languageId
                            select l;
                query = loadPublicLocales.Value ? query.Where(r => !r.ResourceName.StartsWith(AppLocalizationDefaults.AdminLocaleStringResourcesPrefix)) : query.Where(r => r.ResourceName.StartsWith(AppLocalizationDefaults.AdminLocaleStringResourcesPrefix));
                return ResourceValuesToDictionary(query);
            });
        }
            ...
            bool logIfNotFound = true, string defaultValue = "", bool returnEmptyIfNotFound = false)
        {
            ...
            if (_localizationSettings.LoadAllLocaleRecordsOnStartup)
            {
                ...
                var resources = GetAllResourceValues(languageId, !resourceKey.StartsWith(AppLocalizationDefaults.AdminLocaleStringResourcesPrefix, StringComparison.InvariantCultureIgnoreCase));
            ...
            {
                //gradual loading
                var key = string.Format(AppLocalizationDefaults.LocaleStringResourcesByResourceNameCacheKey, languageId, resourceKey);
        ...
        public virtual string ExportResourcesToXml(Language language)
        {
            ...
            xmlWriter.WriteAttributeString("SupportedVersion", AppVersion.CurrentVersion);
