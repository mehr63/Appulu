...
namespace Appulu.Services.Tax
{
    ...
    public partial class TaxCategoryService : ITaxCategoryService
    {
        ...
        public virtual void DeleteTaxCategory(TaxCategory taxCategory)
        {
            ...
            _cacheManager.RemoveByPattern(AppTaxDefaults.TaxCategoriesPatternCacheKey);
        ...
        {
            return _cacheManager.Get(AppTaxDefaults.TaxCategoriesAllCacheKey, () =>
            {
        ...
        public virtual TaxCategory GetTaxCategoryById(int taxCategoryId)
        {
            ...
            var key = string.Format(AppTaxDefaults.TaxCategoriesByIdCacheKey, taxCategoryId);
