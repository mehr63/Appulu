...
namespace Appulu.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendNewReturnRequestUserNotification(ReturnRequest returnRequest, OrderItem orderItem, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendReturnRequestStatusChangedUserNotification(ReturnRequest returnRequest, OrderItem orderItem, int languageId);
