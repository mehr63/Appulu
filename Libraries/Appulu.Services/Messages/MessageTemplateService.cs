...
namespace Appulu.Services.Messages
{
    ...
    public partial class MessageTemplateService : IMessageTemplateService
    {
        ...
        public virtual void DeleteMessageTemplate(MessageTemplate messageTemplate)
        {
            ...
            _cacheManager.RemoveByPattern(AppMessageDefaults.MessageTemplatesPatternCacheKey);
        ...
        public virtual IList<MessageTemplate> GetMessageTemplatesByName(string messageTemplateName, int? storeId = null)
        {
            ...
            var key = string.Format(AppMessageDefaults.MessageTemplatesByNameCacheKey, messageTemplateName, storeId ?? 0);
        ...
        {
            var key = string.Format(AppMessageDefaults.MessageTemplatesAllCacheKey, storeId);
            return _cacheManager.Get(key, () =>
            {
