...
namespace Appulu.Services.Common
{
    ...
    public partial class MaintenanceService : IMaintenanceService
    {
        ...
        {
            var path = _fileProvider.GetAbsolutePath(AppCommonDefaults.DbBackupsPath);
        ...
        public virtual IList<string> GetAllBackupFiles()
        {
            ...
            return _fileProvider.GetFiles(path, $"*.{AppCommonDefaults.DbBackupFileExtension}")
        ...
        public virtual void BackupDatabase()
        {
            ...
            var fileName = $"{GetBackupDirectoryPath()}database_{DateTime.Now:yyyy-MM-dd-HH-mm-ss}_{CommonHelper.GenerateRandomDigitCode(10)}.{AppCommonDefaults.DbBackupFileExtension}";
