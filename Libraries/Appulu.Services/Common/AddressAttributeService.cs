...
namespace Appulu.Services.Common
{
    ...
    public partial class AddressAttributeService : IAddressAttributeService
    {
        ...
        public virtual void DeleteAddressAttribute(AddressAttribute addressAttribute)
        {
            ...
            _cacheManager.RemoveByPattern(AppCommonDefaults.AddressAttributesPatternCacheKey);
            _cacheManager.RemoveByPattern(AppCommonDefaults.AddressAttributeValuesPatternCacheKey);
        ...
        {
            return _cacheManager.Get(AppCommonDefaults.AddressAttributesAllCacheKey, () =>
            {
        ...
        public virtual AddressAttribute GetAddressAttributeById(int addressAttributeId)
        {
            ...
            var key = string.Format(AppCommonDefaults.AddressAttributesByIdCacheKey, addressAttributeId);
        ...
        {
            var key = string.Format(AppCommonDefaults.AddressAttributeValuesAllCacheKey, addressAttributeId);
        ...
        public virtual AddressAttributeValue GetAddressAttributeValueById(int addressAttributeValueId)
        {
            ...
            var key = string.Format(AppCommonDefaults.AddressAttributeValuesByIdCacheKey, addressAttributeValueId);
