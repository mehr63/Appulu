...
namespace Appulu.Services.Common
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        public virtual void DeleteAttribute(GenericAttribute attribute)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(AppCommonDefaults.GenericAttributePatternCacheKey);
        ...
        {
            var key = string.Format(AppCommonDefaults.GenericAttributeCacheKey, entityId, keyGroup);
