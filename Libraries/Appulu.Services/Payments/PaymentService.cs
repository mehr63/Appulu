...
namespace Appulu.Services.Payments
{
    ...
    public partial class PaymentService : IPaymentService
    {
        ...
        public virtual IList<IPaymentMethod> LoadActivePaymentMethods(User user = null, int storeId = 0, int filterByCountryId = 0)
        {
            return LoadAllPaymentMethods(user, storeId, filterByCountryId)
        ...
        public virtual IList<IPaymentMethod> LoadAllPaymentMethods(User user = null, int storeId = 0, int filterByCountryId = 0)
        {
            var paymentMethods = _pluginFinder.GetPlugins<IPaymentMethod>(user: user, storeId: storeId).ToList();
