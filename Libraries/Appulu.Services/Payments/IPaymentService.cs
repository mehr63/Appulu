...
namespace Appulu.Services.Payments
{
    ...
    public partial interface IPaymentService
    {
        ...
        IList<IPaymentMethod> LoadActivePaymentMethods(User user = null, int storeId = 0, int filterByCountryId = 0);
        ...
        IList<IPaymentMethod> LoadAllPaymentMethods(User user = null, int storeId = 0, int filterByCountryId = 0);
