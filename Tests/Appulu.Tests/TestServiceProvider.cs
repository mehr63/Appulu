...
namespace Appulu.Tests
{
    public class TestServiceProvider : IServiceProvider
    {
        public TestServiceProvider()
        {
            ...
            GenericAttributeService.Setup(p => p.GetAttribute<bool>(It.IsAny<User>(), "product-advanced-mode", It.IsAny<int>()))
                .Returns(true);

            GenericAttributeService.Setup(p => p.GetAttribute<bool>(It.IsAny<User>(), "manufacturer-advanced-mode", It.IsAny<int>()))
                .Returns(true);

            GenericAttributeService.Setup(p => p.GetAttribute<bool>(It.IsAny<User>(), "category-advanced-mode", It.IsAny<int>()))
                .Returns(true);
        }
