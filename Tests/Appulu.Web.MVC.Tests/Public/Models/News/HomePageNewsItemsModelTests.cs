...
namespace Appulu.Web.MVC.Tests.Public.Models.News
{
    [TestFixture]
    public class HomePageNewsItemsModelTests
    {
        ...
        {	    
            ...
            newsItemModel2.Comments[0].UserId.ShouldEqual(4);
            newsItemModel2.Comments[0].UserName.ShouldEqual("UserName 1");
            newsItemModel2.Comments[0].UserAvatarUrl.ShouldEqual("UserAvatarUrl 1");
