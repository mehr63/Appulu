...
namespace Appulu.Services.Tests.Orders
{
    ...
    public class OrderTotalCalculationServiceTests : ServiceTest
    {
        ...
        public void Can_get_shopping_cart_subTotal_excluding_tax()
        {
            ...
            cart.ForEach(sci => sci.User = user);
            cart.ForEach(sci => sci.UserId = user.Id);
        ...
        [Test]
        public void Shipping_should_be_free_when_user_is_in_role_with_free_shipping()
        {
            var sci1 = new ShoppingCartItem
            {
                AttributesXml = "",
        ...
        public void Can_get_tax_total()
        {
            ...
            _genericAttributeService.Setup(x => x.GetAttribute<string>(user, AppUserDefaults.SelectedPaymentMethodAttribute, _store.Id))
                .Returns("test1");
        ...
        public void Can_get_shopping_cart_total_with_applied_reward_points()
        {
            ...
            _genericAttributeService.Returns(x => x.GetAttributesForEntity(user.Id, "User"))
                                ...
                                new GenericAttribute
                                    {
                                        StoreId = _store.Id,
                                        EntityId = user.Id,
                                        Key = SystemUserAttributeNames.SelectedPaymentMethod,
                                        KeyGroup = "User",
                                        Value = "test1"
                                    },
                                new GenericAttribute
                                        ...
                                        StoreId = 1,
                                        EntityId = user.Id,
                                        Key = SystemUserAttributeNames.UseRewardPointsDuringCheckout,
                                        KeyGroup = "User",
                                        Value = true.ToString()
                                        }
                            });
            ...
            user.AddRewardPointsHistoryEntry(15, 0); //15*2=30
        ...
        public void Can_get_shopping_cart_total_discount()
        {
            ...
            _genericAttributeService.Setup(x =>
                    x.GetAttribute<string>(user, AppUserDefaults.SelectedPaymentMethodAttribute, _store.Id))
                .Returns("test1");
