...
namespace Appulu.Services.Tests.Catalog
{
    [TestFixture]
    public class PriceCalculationServiceTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            appEngine.Setup(x => x.ServiceProvider).Returns(_serviceProvider);
        ...
        public void Can_get_final_product_price()
        {
            ...
            _priceCalcService.GetFinalPrice(product, user, 0, false).ShouldEqual(12.34M);
            _priceCalcService.GetFinalPrice(product, user, 0, false, 2).ShouldEqual(12.34M);
        }
        ...
        public void Can_get_final_product_price_with_tier_prices()
        {
            ...
            _priceCalcService.GetFinalPrice(product, user, 0, false).ShouldEqual(12.34M);
            _priceCalcService.GetFinalPrice(product, user, 0, false, 2).ShouldEqual(10);
            _priceCalcService.GetFinalPrice(product, user, 0, false, 3).ShouldEqual(10);
            _priceCalcService.GetFinalPrice(product, user, 0, false, 5).ShouldEqual(9);
            _priceCalcService.GetFinalPrice(product, user, 0, false, 10).ShouldEqual(9);
        }

        [Test]
        public void Can_get_final_product_price_with_tier_prices_by_userRole()
        {
            ...
            _priceCalcService.GetFinalPrice(product, user, 0, false, 2).ShouldEqual(10);
            _priceCalcService.GetFinalPrice(product, user, 0, false, 3).ShouldEqual(10);
            _priceCalcService.GetFinalPrice(product, user, 0, false, 5).ShouldEqual(8);
            _priceCalcService.GetFinalPrice(product, user, 0, false, 10).ShouldEqual(8);
        }
        ...
        public void Can_get_final_product_price_with_additionalFee()
        {
            ...
            _priceCalcService.GetFinalPrice(product, user, 5, false).ShouldEqual(17.34M);
        }
        ...
        public void Can_get_final_product_price_with_discount()
        {
            ...
            _priceCalcService.GetFinalPrice(product, user).ShouldEqual(9.34M);
        }
