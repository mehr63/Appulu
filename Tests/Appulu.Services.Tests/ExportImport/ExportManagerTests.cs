...
namespace Appulu.Services.Tests.ExportImport
{
    [TestFixture]
    public class ExportManagerTests : ServiceTest
    {
        ...
        private Mock<IUserAttributeFormatter> _userAttributeFormatter;
        ...
        public new void SetUp()
        {
            ...
            _userAttributeFormatter = new Mock<IUserAttributeFormatter>();
            ...
            _authenticationService.Setup(p => p.GetAuthenticatedUser()).Returns(GetTestUser());
            ...
            _exportManager = new ExportManager(_addressSettings,
                ...
                _userAttributeFormatter.Object,
                _userService.Object,
        ...
        public void Can_export_orders_xlsx()
        {
            ...
            var orders = new List<Order>
            {
                new Order
                {
                    ...
                    CurrencyRate = 1.1M,
                    UserTaxDisplayType = TaxDisplayType.ExcludingTax,
                    VatNumber = "123456789",
        ...
        [Test]
        public void Can_export_users_to_xlsx()
        {
            ...
            var excelData = _exportManager.ExportUsersToXlsx(users);
            var worksheet = GetWorksheets(excelData);
            ...
            var ignore = new List<string> { "Id", "ExternalAuthenticationRecords", "UserRoles", "ShoppingCartItems",
                ...
                "UserUserRoleMappings", "UserAddressMappings" };
        ...
        public void Can_export_products_to_xlsx()
        {
            ...
            var products = new List<Product>
            {
                new Product
                {
                    ...
                    MinimumUserEnteredPrice = 40,
                    MaximumUserEnteredPrice = 60,
