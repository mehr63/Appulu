...
namespace Appulu.Core.Tests
{
    ...
    public class WebHelperTests
    {
        ...
        private Mock<IAppFileProvider> _fileProvider;
        ...
        public void SetUp()
        {
            ...
            _fileProvider = new Mock<IAppFileProvider>();
        ...
        {
            _httpContext.Request.PathBase = "/appulupath";
            _webHelper.GetStoreLocation(false).ShouldEqual("http://www.Example.com/appulupath/");
        }
